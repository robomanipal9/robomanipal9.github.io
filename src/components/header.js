		...
		<div>
			<Navbar expand="xl" fixed="top" className="bg-black navbar-dark" style={{ fontFamily: "Montserrat" }}>
				<div
					...
					className="navbar-brand order-xl-0 mx-auto"
					style={{ padding: "1rem" }}>
					<img alt="logo" id="logo" src="./assets/images/logo2.jpg" style={{ height: 50 }}></img>
				</div>
				...
				<Collapse isOpen={isOpen} navbar className="order-xl-1">
					<Nav className="ml-auto" navbar>
						<NavItem className="mx-auto navlink">
							<a href="/#/" className="navlink nav-link">
								HOME
							</a>
						</NavItem>
						<NavItem className="mx-auto navlink">
							<Link
								to="/#about"
								activeClass="active"
								scroll={(el) => scrollWithOffset(el, 98)}
								duration={2000}
						...
						<NavItem className="mx-auto navlink">
							<a href="/#/work" className="navlink nav-link">
								WORK
							</a>
						</NavItem>
						<NavItem className="mx-auto navlink">
							<a href="/#/competition" className="navlink nav-link">
								COMPETITIONS
							</a>
						</NavItem>
						...
						<NavItem className="mx-auto navlink">
							<a href="/#/gallery" className="navlink nav-link">
								GALLERY
							</a>
						</NavItem>
						<NavItem className="mx-auto navlink">
