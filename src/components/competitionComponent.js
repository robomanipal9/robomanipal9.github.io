			...
			<Container>
				<Row className="comp">
					...
					<div data-aos="fade-right" class="col-lg-8 col-sm-12 compinfo">
						...
						<strong>- Qualified for Stage 2 of Robocon 2019</strong><br/>
						<strong>- Qualified for Stage 2 of Robocon 2020</strong><br/>
						<strong>- Qualified for Stage 2 of Robocon 2021 with a score of 100/100</strong><br/>
				...
				<Row className="comp" style={{ paddingBottom: '50px', marginTop: '20px' }}>
					<div data-aos="fade-left" class="col-lg-12 col-sm-12 compinfo">
						<h4 style={{ fontFamily: 'Montserrat-Bold', textAlign: 'center', marginBottom: '30px' }}>OTHER COMPETITIONS</h4>
						<div>
							<h5 style={{ fontFamily: 'Montserrat-Bold' }}>India Innovation Challenge Design Contest (IICDC)</h5>
							<p>
								IICDC is a national innovation contest wherein teams participate to create a new innovative product using TI components.
							</p>
							<strong>- Reached the semifinal of IICDC 2019, a technical competition hosted by IIM Bangalore</strong>
						</div>
						<div className='othercomp'>
							<h5 style={{ fontFamily: 'Montserrat-Bold' }}>Takshak</h5>
							<p>
								In 2021, the team was given a problem statement where they had to develop and refine a path planning algorithm that 
								would allow a robot to navigate the given environment.
							</p>
						...
						<div className='othercomp'>
							...
							<p>
								In October, 2021, our team participated in the Disenyo PCB Challenge which was hosted in association with Indian 
								Printed Circuit Association (IPCA).
							</p>
						...
						<div className='othercomp'>
							...
							<p>
								Our team participates annually in various competitions related to robotics at Techfest which is the annual science and 
								technology festival of IIT Bombay.
							</p>
						...
						<div className='othercomp'>
							...
							<p>
								At e-Yantra, the team is challenged to design and simulate a robotic mechanism which navigates through galleries present 
								in different rooms of an indoor farm and harvest berries based on factors.
							</p>
						</div>
					</div>
				</Row>
