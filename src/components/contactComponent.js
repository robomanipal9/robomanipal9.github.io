...
function Test() {
	...
	return (
		<div className="contact">
			<div data-aos="fade-right" className="col-12 col-md-7 form"></div>
			<div data-aos="fade-down" className="col-12 col-md-5 offset-md-7 contactinfo">
				<div style={{ height: "50%", padding: "60px" }}>
					...
					<address>
						...
						<a href="tel:+919630093604" style={{ color: "black" }}>
							+91 96300 93604
						</a>{" "}
						<br /> <br />
						<a href="mailto:team.robomanipal@gmail.com" style={{ color: "black" }}>
