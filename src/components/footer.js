				...
				<div className="col-12 col-md-8 text-center mx-auto">
					...
					<div className="row justify-content-center" style={{ paddingTop: "20px" }}>
						<ul className="list-unstyled list-inline">
							...
							<li className="list-inline-item">
								<a
									href="https://www.instagram.com/team.robomanipal?igshid=dw2nx6r5lcdb"
									className="btn-lg"
									target="_blank"
									rel="noreferrer">
							...
							<li className="list-inline-item">
								<a
									href="https://www.linkedin.com/company/robomanipal/"
									className="btn-lg"
									target="_blank"
									rel="noreferrer">
							...
							<li className="list-inline-item">
								<a
									href="https://www.youtube.com/channel/UCTbPo4SEzAb_BtcKik-hGpA"
									className="btn-lg"
									target="_blank"
									rel="noreferrer">
